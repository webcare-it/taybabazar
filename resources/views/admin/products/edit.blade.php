...
{{--                                                </div>--}}
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label>Product Rating => 1 to 5 ( Optional )</label>
                                                    <input type="text" name="rating" value="{{ $product->rating  }}" class="form-control" placeholder="Product code ">
...
{{--                                                </div>--}}
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="video_link" value="{{$product->video_link}}" class="form-control" placeholder="Only source link..">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
